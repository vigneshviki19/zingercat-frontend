...
export default function Chat() {
    ...
    useEffect(() => {
        ...
        return () => socket.off("receivePrivate");
    }, [me]);
                ...
                <div className="zc-container">
                    <div className="zc-sidebar">
                        ...
                        {loading ? (
                            ...
                            <div className="zc-empty-friends"> "No friends yet. Go find some cats! 🐾" </div>
                        ) : (
                            friends.map((friend) => (
                                <div key={friend.username} className="zc-friend-item" onClick={() => handleFriendClick(friend.username)}>
                                    ...
                                    {unreadMessages[friend.username] > 0 && (
                                        <div className="zc-unread-badge">
                                            {unreadMessages[friend.username] > 99 ? "99+" : unreadMessages[friend.username]}
                                        </div>
                                    )}
                                </div>
                            ))
