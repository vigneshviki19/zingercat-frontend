    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .zh-nav-item-logout {
          color: #C0392B;
          border: 1px solid rgba(255,188,176,0.5);
        }
        ...
        .zh-post-btn:hover:not(:disabled) {
        ...
        .zh-post {
          ...
          padding: 18px 20px;
          margin-bottom: 16px;
          box-shadow: 0 2px 16px rgba(200,120,60,0.06);
        ...
        .zh-post-avatar {
          ...
          font-size: 20px;
          flex-shrink: 0;
          border: 2px solid rgba(244,133,74,0.25);
          cursor: pointer;
        }
        .zh-post-author {
          font-weight: 500;
